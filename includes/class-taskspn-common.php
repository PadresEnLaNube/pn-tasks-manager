...
class TASKSPN_Common {
    ...
    if(!wp_script_is($this->plugin_name . '-owl', 'enqueued')) {
		...
		if ($nonce_verified) {
			$taskspn_action = isset($_GET['taskspn_action'])
				? TASKSPN_Forms::taskspn_sanitizer(sanitize_text_field(wp_unslash($_GET['taskspn_action'])))
				: '';
			$taskspn_btn_id = isset($_GET['taskspn_btn_id'])
				? TASKSPN_Forms::taskspn_sanitizer(sanitize_text_field(wp_unslash($_GET['taskspn_btn_id'])))
				: '';
			$taskspn_popup = isset($_GET['taskspn_popup'])
				? TASKSPN_Forms::taskspn_sanitizer(sanitize_text_field(wp_unslash($_GET['taskspn_popup'])))
				: '';
			$taskspn_tab = isset($_GET['taskspn_tab'])
				? TASKSPN_Forms::taskspn_sanitizer(sanitize_text_field(wp_unslash($_GET['taskspn_tab'])))
				: '';
		}
